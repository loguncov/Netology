...
public:
  ...
  tridiagonal_matrix(const std::vector<double> &down,
                     ...
                     const std::vector<double> &middle) : m_down{
                                                              down},
                                                          m_upper{upper}, m_middle{middle} {};
  ~tridiagonal_matrix()
  {
  ...
  {
    auto new_matrix = std::make_unique<tridiagonal_matrix>(m_down,
                                                           m_upper,
                                                           m_middle);
    return new_matrix;
  }
...
int main()
{
  ...
  auto matrix = std::make_unique<tridiagonal_matrix>(down,
                                                     upper,
                                                     middle);
